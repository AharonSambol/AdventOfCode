   ...
   HOW IZ I ADVENTpt1 YR INPUT
      ...
      LENGTH R I IZ STRING'Z LEN YR INPUT MKAY 
	   IM IN YR LOOPY UPPIN YR INDX TIL BOTH SAEM INDX AN LENGTH 
         ...
         CHAR, WTF?
            OMG ","
               BTW CHECK IF RIGHT NUMBER OF APEARENCES OF CHAR AND THEN ADD TO COUNT AND RESET ALL
